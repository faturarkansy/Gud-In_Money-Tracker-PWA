...
export default function TransactionsPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-100 flex items-center justify-center p-0 sm:p-4">
      {/* 🌟 PEMBUNGKUS UTAMA MOCKUP HANDPHONE IDENTIK DENGAN PAGE.TSX */}
      <div className="relative w-full max-w-md min-h-screen sm:min-h-screen sm:rounded-[40px] sm:shadow-2xl bg-[#FCFCF9] overflow-hidden p-0 flex flex-col justify-between">
        {/* Konten Scrollable */}
        <div className="z-10 w-full flex flex-col pt-6 pb-28 overflow-y-auto no-scrollbar flex-1">
          {/* TITLE APP BAR */}
          ...
          {/* DETAIL TRANSACTION CONTAINER PANEL */}
          <div className="w-full bg-white border-t border-gray-100 rounded-t-[36px] px-6 pt-5 flex-1 shadow-[0_-12px_40px_rgba(0,0,0,0.02)] min-h-[300px]">
